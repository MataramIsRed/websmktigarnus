                      ...
                      <form method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-9">
                            <input type="text" name="kode_staff" class="form-control">
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-9 input-lg">
                            <input type="text" name="role" class="form-control" placeholder="contoh: 10/11/12" data-inputmask="'mask' : '(999) 999-9999'" required>
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="x_panel">
                          ...
                          <div class="x_content">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                              ...
                              <tbody>
                              <?php
                              $query = mysqli_query($conn,"SELECT * FROM data_staff");
                              $no=1;
                              ...
                              ?>
                                ...
                                <tr>
                                  <td><?php echo $no;?></td>
                                  <td><?php echo $data['kode_staff'];?></td>
...
if (isset ($_POST['Simpan'])){
  ...
  $pindah = move_uploaded_file($sumber, '../foto/'.$nama_file);
        ...
        $sql_simpan = "INSERT INTO data_staff VALUES (
      '".$_POST['kode_staff']."',
      '".$_POST['nama']."',
      '".$_POST['jekel']."',
      '".$_POST['role']."',
    ...
    $query_simpan = mysqli_query($conn, $sql_simpan);
        ...
        if ($query_simpan) {
          ...
          $sql_hapus = "DELETE FROM data_staff WHERE kode_staff='".$_POST['kode_staff']."';";
