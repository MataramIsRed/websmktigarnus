                                    ...
                                    <li>
                                        ...
                                        <a href="lihat-pesan?id_pesan=<?= $row_pesan1['id_pesan']; ?>">
                                            ...
                                            <h4 style="font-family: 'Quicksand', sans-serif">
                                                ...
                                                $query_cek_verif = mysqli_query($koneksi, "SELECT * FROM user_perpus WHERE fullname = '$nama'");
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><?= $_SESSION['fullname']; ?>
                            ...
                            $id = $_SESSION['id_user'];
                            $query_verif = mysqli_query($koneksi, "SELECT * FROM user_perpus WHERE id_user = '$id'");
