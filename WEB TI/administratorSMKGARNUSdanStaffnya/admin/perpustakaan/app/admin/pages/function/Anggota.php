...
if ($_GET['aksi'] == "tambah") {
    ...
    $sql = "INSERT INTO user_perpus(kode_user,nis,fullname,username,password,kelas,alamat,verif,role,join_date)
    ...
    $query = "UPDATE user_perpus SET nis = '$nis', fullname = '$nama_lengkap', username = '$username', 
    ...
    $sql = mysqli_query($koneksi, "DELETE FROM user_perpus WHERE id_user = $id_user");
