...
if ($_GET['act'] == "tambah") {
    ...
    $query = "INSERT INTO user_perpus(kode_user,nis,fullname,username,password,kelas,alamat,verif,role,join_date)
    ...
    $query = "UPDATE user_perpus SET fullname = '$fullname', username = '$username', password ='$password'";
    ...
    $query = mysqli_query($koneksi, "DELETE FROM user_perpus WHERE id_user = $id_admin");
