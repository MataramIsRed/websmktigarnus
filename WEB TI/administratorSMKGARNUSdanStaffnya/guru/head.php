...
session_start();
include "../connn.php";
if(isset($_SESSION['login']) && $_SESSION['kedudukan'] == "guru"){
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body class="nav-md">
    <div class="container body">
      ...
      <div class="col-md-3 left_col menu_fixed">
        <?php
                  $query0 = mysqli_query($conn,"SELECT * FROM data_guru WHERE kode_pengajar='".$_SESSION['kode']."'");
                  $no=1;
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="../foto/<?php if($data['foto'] != NULL){echo $data['foto'];}else{echo "Logo.png";}?>" alt="..." class="img-circle profile_img">
              </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="../foto/<?php if($data['foto'] == NULL){
                      echo "Logo.png";
                    }else{
                        echo $data['foto'];
                        }?>" alt="">SMK TI GARNUS 
                  ...
                  <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                    <li class="nav-item">
                      <a class="dropdown-item">
                        <span class="image"><img src="../foto/<?php if($data['foto'] == NULL){
                          echo "Logo.png";
                        }else{
                            echo $data['foto'];
                             } 
