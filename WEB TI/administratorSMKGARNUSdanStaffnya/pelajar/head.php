    ...
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col menu_fixed">
            ...
            <?php
                  $query0 = mysqli_query($conn,"SELECT * FROM data_siswa WHERE nis='".$_SESSION['nis']."'");
                  $no=1;
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="../foto/<?php echo $data['foto'];?>" alt="..." class="img-circle profile_img">
              </div>
                ...
                <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Absen <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="riwayat.php">Riwayat Absen</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="../foto/<?php echo $data['foto'];?>" alt="">Settings
                  </a>
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item"  href="javascript:;" data-toggle="modal" data-target="#modelId"> Profile</a>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="container-fluid d-flex justify-content-space-around">
                      ...
                      <div class="col-md-12">
                        <h2>Jurusan: <?php echo $data['jurusan'];?></h2>
                      </div>
                      <div class="col-md-12">
                        <h2>Kelas: <?php echo $data['kelas'];?></h2>
                      </div>
                      <?php
}
                      ?>
