...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2023 at 04:18 PM
...
(30, 123, 'Rizal', '11', 'PPLG', '2023-11-20', '18:45:57', 'Terlambat'),
(31, 190, 'Rusdi Parasdhiya', '11', 'RPL', '2023-11-18', '20:26:32', 'Terlambat');
...
(123, 'Rizal', 'Laki-laki', '11', 'PPLG', 'download.jpg', 30),
(190, 'Rusdi Parasdhiya', 'Laki-laki', '11', 'RPL', '', 15);
...
INSERT INTO `data_staff` (`kode_staff`, `nama`, `role`, `jenis_kelamin`, `foto`) VALUES
...
--
ALTER TABLE `absen_siswa`
  ADD CONSTRAINT `fk_nis` FOREIGN KEY (`nis`) REFERENCES `data_siswa` (`nis`);
COMMIT;
